    ...
    <section id="about" className="w-full py-32 bg-[#050505] border-t border-white/5 flex justify-center relative z-20">
      <div className="w-full max-w-6xl mx-auto px-6">
        <div className="mb-20 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">The Engineer Behind the Code</h2>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">Dedicated to building scalable systems and impactful digital experiences.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-3xl font-black text-white mb-2">Nadeem Shaikh</h3>
            <p className="text-brand-orange font-semibold mb-6 uppercase tracking-wider text-sm">Full Stack Web Developer</p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="px-5 py-3 bg-[#111111] border border-white/10 rounded-xl flex items-center gap-3 text-gray-300 font-medium">
                  <Briefcase className="w-5 h-5 text-rose-500" /> Software Engineer
              </div>
            </div>
          </motion.div>
